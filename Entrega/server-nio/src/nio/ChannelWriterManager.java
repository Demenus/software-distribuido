...
public class ChannelWriterManager implements WriterManager<ChannelUtils.Writer> {

    private ChannelUtils.Writer mWriter;

    public ChannelWriterManager(ChannelUtils.Writer writer) {
        mWriter = writer;
    }

    @Override
    public void runWriteOperation(WriteOperation<ChannelUtils.Writer> operation) throws WriteException, TimeOutException {
        try {
    ...
    public void writeStartBet(final int bet) throws WriteException, TimeOutException {
        runWriteOperation(new WriteOperation<ChannelUtils.Writer>() {
            @Override
            public void write(ChannelUtils.Writer writer) throws IOException {
